...
email.send({
    ...
    text: 'Reset Password', 
    html: '<h3>Please click the following link to reset your password</h3><a href="https://sit313-task-6-3d.herokuapp.com/resetpwd">https://sit313-task-6-3d.herokuapp.com/resetpwd</a>'
  });
  res.redirect('/');
});
...
mongoose.connect("mongodb+srv://yuhao:yyhmxdzh0719@cluster0.hvfpp.mongodb.net/iCrowdTaskDB?authSource=admin&replicaSet=atlas-uq5o3a-shard-0&readPreference=primary&appname=MongoDB%20Compass%20Community&ssl=true",{useNewUrlParser:true, useUnifiedTopology:true})
